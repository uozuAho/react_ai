import { ISearchProblem } from '../../../../ai_lib/algorithms/search/search_problem';
import { ISearchAlgorithm } from '../../../../ai_lib/algorithms/search/search_algorithm';
...
export class Graph2dSearchVisualiser {
    ...
    private _generateSolver: (problem: ISearchProblem<Point2d, Point2d>, goal: Point2d) =>
        ISearchAlgorithm<Point2d, Point2d>;
    private _solver: ISearchAlgorithm<Point2d, Point2d>;
    private _diagram: Graph2dSearchDiagram;
    private _interval: any;

    constructor(canvasId: string, height: number, width: number,
            generateSolver: (problem: ISearchProblem<Point2d, Point2d>, goal: Point2d) =>
            ISearchAlgorithm<Point2d, Point2d>) {
